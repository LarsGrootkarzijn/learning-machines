local simMujoco = loadPlugin 'simMujoco-3-2-4';
...
function simMujoco.composite(...)
    ...
    local injectionId = simMujoco._composite3_2_4(xml, info)
    sim.setStepping(lb)
    return injectionId
end
...
function simMujoco.injectXML(...)
    ...
    local injectionId = simMujoco._injectXML3_2_4(xml, item2, info)
    sim.setStepping(lb)
    return injectionId
end

function simMujoco.removeXML(...)
    return simMujoco._removeXML3_2_4(...)
end

function simMujoco.getCompositeInfo(...)
    return simMujoco._getCompositeInfo3_2_4(...)
end
